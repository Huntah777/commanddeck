/* ============================================================
   Madinah · Command Deck — /api/unsplash
   ------------------------------------------------------------
   ...
   is authenticated with the app's SYNC_TOKEN, same as /api/state.

   Bindings (Cloudflare Pages → Settings → Environment variables):
     env.SYNC_TOKEN         secret (same token used by /api/state)
     env.UNSPLASH_ACCESS_KEY  secret (Unsplash Developer Access Key)
   ============================================================ */
